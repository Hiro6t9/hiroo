...
const ProjectsSection: React.FC = () => {
  const projects = [
    ...
    {
      title: "SkriptHub",
      description: "Community platform for sharing and discovering Skript plugins with version control and live testing.",
      tags: ["Development", "Community", "Minecraft"],
      image: "https://images.unsplash.com/photo-1500673922987-e212871fec22?auto=format&fit=crop&w=800&q=80",
      link: "#"
    },
    {
      title: "NetVision UI",
      description: "Futuristic dashboard interface for network monitoring with real-time data visualization.",
      tags: ["UI Design", "Dashboard", "React"],
